...
class tx_ccsetsearch_modfunc1 extends \TYPO3\CMS\Backend\Module\AbstractFunctionModule
{
    ...
    function showPageTree()
    {
        $tableLayout = [
            'table' => [
                '<table border="0" cellspacing="1" cellpadding="0" id="typo3-tree" style="width:auto;">',
                '</table>'
            ],
            '0' => [
                'tr' => ['<tr class="tableheader bgColor5">', '</tr>'],
                '0' => ['<td colspan="2" align="right" nowrap="nowrap" class="bgColor5">', '</td>'],
                '1' => ['', ''],
            ],
            'defRow' => [
                'tr' => ['<tr class="bgColor4">', '</tr>'],
                '0' => ['<td nowrap="nowrap">', '</td>'],
                '1' => ['<td align="center" nowrap="nowrap">&nbsp;&nbsp;', '&nbsp;&nbsp;</td>'],
            ]
        ];
